...
export default function Home() {
  const { user, loading, canSave, canValidate, isOrgActive} = useAuth();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-white0 text-sm">Memuat...</p>
        </div>
      </div>
    );
  }
  ...
  return <ChefDashboard canSave={canSave} canValidate={canValidate} isOrgActive={isOrgActive} />;
}
