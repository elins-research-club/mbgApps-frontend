    ...
    if (savedPlateRecipes) {
      try {
        ...
        const parsedRecipes = recipes.map(recipe => ({
          ...recipe,
          rincian_bahan: typeof recipe.rincian_bahan === 'string' ? JSON.parse(recipe.rincian_bahan) : recipe.rincian_bahan,
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-grow bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Tidak Ada Menu</h2>
            <p className="text-gray-600 mb-6">Silakan tambahkan menu di Meal Planner terlebih dahulu</p>
            <button
        ...
        <div className="bg-white shadow-sm border-b border-gray-200 mb-6">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Detail Rencana Makan</h1>
                <p className="text-sm text-gray-600 mt-1">Bahan-bahan dan informasi nutrisi untuk setiap menu</p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-xl font-bold text-gray-800 mb-6">Bahan-Bahan Menu</h2>
                <div className="space-y-6">
                  {plateRecipes.map((recipe, index) => (
                    <div key={recipe.id} className="border-b border-gray-200 pb-6 last:border-b-0 last:pb-0">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="bg-orange-50 px-3 py-1 rounded-lg">
                          <p className="text-sm font-semibold text-orange-700">
                            {((recipe.total_gramasi || 0) * (parseFloat(recipe.quantity) || 1)).toFixed(1)}g
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 mt-3">
                        <h4 className="text-sm font-semibold text-gray-700 mb-3">Bahan:</h4>
                        {(() => {
                          const ingredients = recipe.rincian_bahan || recipe.bahan;
                          console.log('Recipe ingredients:', ingredients);
                          console.log('Recipe ingredients type:', typeof ingredients);
                          
                          if (!ingredients) {
                            return <p className="text-sm text-gray-500 italic">Tidak ada data bahan</p>;
                          }
                                ...
                                {ingredients.map((ingredient, idx) => (
                                  <li key={idx} className="flex items-start">
                                    ...
                                    <span className="text-sm text-gray-700">
                                      <span className="font-medium">{ingredient.nama || ingredient.name || 'Bahan'}</span>
                                      {ingredient.gramasi && (
                          ...
                          return <p className="text-sm text-gray-500 italic">Tidak ada data bahan (format tidak valid)</p>;
                        })()}
                      </div>
                    </div>
                  ))}
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
            ...
            <div className="text-center">
              <div className="mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Meal Plan Tersimpan!</h2>
                <p className="text-gray-600 mb-6">Scan QR code untuk mengakses meal plan ini kapan saja</p>
              </div>
